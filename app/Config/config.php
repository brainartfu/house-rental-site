...
return [
    ...
    'post_types' => [
        ...
        'car' => [
            ...
            'names' => awe_lang('Cars'),
            'slug' => 'autoveicoli',
            'search_slug' => 'ricerca-autoveicoli',
            'only_search_form' => false
        ],
        'post' => [
            'name' => awe_lang('Post'),
    ...
    'admin_menu' => [
        ...
        [
            ...
            'child' => [
                ...
                [
                    ...
                    'screen' => 'get-terms/home-type',
				     ...
				     [
                    'type' => 'item',
                    'label' => awe_lang('Types2'),
                    'screen' => 'get-terms/home-typesec',
                ],
                [
                    'type' => 'item',
            ...
            'screen' => ['add-new-home', 'my-home', 'edit-home', 'review/home', 'get-terms/home-type', 'get-terms/home-typesec', 'get-terms/home-amenity']
        ],
        [
            'type' => 'parent',
    ...
    'home_settings' => [
        ...
        'fields' => [
            ...
            [
			    ...
			    [
                'id' => 'home_typesec',
                'label' => awe_lang('Home Type additional'),
                'type' => 'select',
                'choices' => 'terms:home-typesec',
                'field_type' => 'taxonomy',
                'layout' => 'col-12 col-md-3',
                'break' => true,
                'style' => 'wide',
            ...
            [
              ...
              [
                'id' => 'number_of_double_beds',
                'label' => awe_lang('No. of double Beds'),
                'type' => 'number',
                'minlength' => 1,
                'std' => 1,
                'validation' => 'required|integer',
                ...
                'section' => 'detail_options'
                 ...
                 [
                'id' => 'number_of_single_beds',
                'label' => awe_lang('No. of single Beds'),
                'type' => 'number',
                'minlength' => 1,
                'std' => 1,
                'validation' => 'required|integer',
            ...
            [
				...
				[
                'id' => 'acconto',
                'label' => awe_lang('Deposit'),
				'desc' => awe_lang('Set a down payment percentage that will be calculated at checkout Please enter only a numeric value without%'),
                'type' => 'text',
                'validation' => 'required',
                'translation' => true,
                'section' => 'pricing_options'
         ...
         /*  TESTIMONIAL MANUALI  [
           ...
           /*  [
            ...
            [
			 ...
			 [
                'id' => 'footer_menu3_label',
                'label' => awe_lang('Third menu label'),
                'type' => 'text',
                'layout' => 'col-12 col-md-3',
                'break' => false,
                'translation' => true,
