...
<div class="container shadowtr">
	<div class="row">
					...
					<div class="col-md-2 col-sm-12 mb-2 mt-2">
						...
						<h4 class="footer-title text-light mb-1"><?php echo e(get_option('footer_subscribe_label')); ?></h4>
							<p class="text-light"><?php echo e(get_option('footer_subscribe_description')); ?></p>
						</div>
					</div>
					<div class="col-md-9 col-sm-12 mb-2 mt-2">
                        ...
                        <input type="email" id="mc-email" name="email" placeholder="<?php echo e(__('Enter your email')); ?>"
                               class="col-md-9 col-sm-12 mb-2 mt-2 form-control has-validation text-dark" data-validation="required"/>
									<button class="col-md-2 col-sm-12 mb-2 mt-2"><?php echo e(__('Signup newsletter')); ?> <i class="fas fa-long-arrow-alt-right"></i></button>
								</form>
							</div>
						</div>
					</div>
...
</style><?php /**PATH /home/salentovacanze/public_html/app/Views/frontend/components/newsletter.blade.php ENDPATH**/ ?>