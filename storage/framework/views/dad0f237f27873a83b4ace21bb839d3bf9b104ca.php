...
?>
 ...
 <?php
    foreach($titles as $title) { ?>
      <option value="<?= $title ?>" <?= $title==$address?'selected':'' ?>><?= $title ?></option>
  <?php
    } ?>
</select> 
                        </select>
...
<?php /**PATH /home/salentovacanze/public_html/app/Views/frontend/home/search/search.blade.php ENDPATH**/ ?>